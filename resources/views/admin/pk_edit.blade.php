    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="row mb50">
                    <div class="col-sm-6">
                        <form id="new_package_form" action="{{route('admin.pk_edit')}}" method="post">
                            @csrf
                            <input type="hidden" name="id" value="{{$package->id}}" />
                            <div class="form-group">
                                <label for="name">Title</label>
                                <input type="text" name="title" class="form-control" value="{{$package->name}}" required autofocus />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="rows" class="form-control" value="{{$package->rows}}" required />
                            </div>
                            <div class="form-group">
                                <label for="name">Description</label>
                                <input type="text" name="description" class="form-control" value="{{$package->description}}" required />
                            </div>
                            <div class="form-group">
